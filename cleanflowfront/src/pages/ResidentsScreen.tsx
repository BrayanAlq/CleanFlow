...
export const ResidentsScreen = () => {
  ...
  const residents = useMemo(() => {
    ...
    return allResidents.slice(start, start + PAGE_SIZE)
  }, [allResidents, page])
            ...
            <table className="w-full text-sm font-normal text-white">
              <thead>
                <tr className="border-b-[0.1px] border-border-accent text-white/50">
                  ...
                  <th className="text-left font-normal py-3 px-4">Direcci&oacute;n</th>
                  <th className="text-left font-normal py-3 px-4">Reportes</th>
                  <th className="text-left font-normal py-3 px-4">Medallas</th>
              ...
              <tbody>
                {residents.map(resident => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-white/70">{resident.username}</td>
                    <td className="py-3 px-4 text-white/70">{resident.email}</td>
                    <td className="py-3 px-4 text-white/70 max-w-40 truncate">{resident.address}</td>
                    <td className="py-3 px-4 text-white/70">{resident.report_count}</td>
