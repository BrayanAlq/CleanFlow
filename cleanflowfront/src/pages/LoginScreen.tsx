...
export const LoginScreen = () => {
  ...
  const loginMutation = useMutation<LoginResponse, AxiosError<ErrorApiType>, LoginRequest>({
    mutationFn: login,
    onSuccess: data => {
    ...
    <div className="relative h-dvh w-dvw flex flex-col items-center justify-center bg-sky-900">
      ...
      <div className="flex flex-col w-[80dvw] h-[80dvh] rounded-2xl py-20 px-40 gap-5 transition-all duration-300 ease-in-out">
        ...
        <div className="flex gap-20">
          <div className="w-1/2 text-3xl text-white font-normal">Inicia sesión</div>
          <form
            ...
            <div className="w-full flex flex-col gap-5">
              <div
                className={`
                  ...
                  ${loginError ? 'max-h-20 opacity-100 scale-100 mb-0' : 'max-h-0 opacity-0 scale-95'}
                `}
              >
